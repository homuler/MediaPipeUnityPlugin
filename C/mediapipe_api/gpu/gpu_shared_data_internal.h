...
MP_CAPI(MpReturnCode) mp_StatusOrGpuResources__status(absl::StatusOr<SharedGpuResources>* status_or_gpu_resources,
                                                      absl::Status** status_out);
MP_CAPI(MpReturnCode) mp_StatusOrGpuResources__value(absl::StatusOr<SharedGpuResources>* status_or_gpu_resources,
