...
MP_CAPI(MpReturnCode) mp_Packet__GetImageFrame(mediapipe::Packet* packet, mediapipe::ImageFrame** value_out);
MP_CAPI(MpReturnCode) mp_Packet__ConsumeImageFrame(mediapipe::Packet* packet, mediapipe::ImageFrame** value_out);
