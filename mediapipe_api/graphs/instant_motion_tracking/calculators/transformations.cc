...
MpReturnCode mp__MakeAnchor3dVectorPacket_At__PA_i_Rt(const mediapipe::Anchor3d* value,
                                                                         int size,
...
void mp_Anchor3dArray__delete(mediapipe::Anchor3d* anchor_vector_data) {
