...
namespace Mediapipe {
  ...
  static class GpuBufferFormatExtension {
    public static int ImageFormatFor(this GpuBufferFormat gpuBufferFormat) {
      return UnsafeNativeMethods.MpImageFormatForGpuBufferFormat((UInt32)gpuBufferFormat);
    }
